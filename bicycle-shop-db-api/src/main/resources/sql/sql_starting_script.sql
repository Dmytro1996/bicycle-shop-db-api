...
TYPE ENUM('MTB', 'Road', 'Gravel', 'City') NOT NULL, FRAME_SIZE VARCHAR(2) NOT NULL, WHEEL_SIZE INT NOT NULL,
...
BICYCLE_ID INT NOT NULL REFERENCES BICYCLE(ID),
FIRST_NAME VARCHAR(50), LAST_NAME VARCHAR(50),
EMAIL VARCHAR(50), PHONE VARCHAR(13), ADDRESS VARCHAR(50),
DELIVERED BOOLEAN DEFAULT FALSE,PRIMARY KEY(ID));